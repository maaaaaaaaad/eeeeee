...
class HomeRepositoryImpl implements HomeRepository {
  ...
  Future<Either<Failure, Owner>> getMyProfile() async {
    try {
      ...
      return Left(ApiErrorHandler.fromDioException(e, fallback: '프로필을 불러올 수 없습니다'));
    } catch (_) {
      return const Left(ServerFailure('프로필을 불러올 수 없습니다'));
    }
  }
  ...
  Future<Either<Failure, List<BeautyShop>>> getMyShops() async {
    try {
      ...
      return Left(ApiErrorHandler.fromDioException(e, fallback: '샵 목록을 불러올 수 없습니다'));
    } catch (_) {
      return const Left(ServerFailure('샵 목록을 불러올 수 없습니다'));
    }
  }
}
