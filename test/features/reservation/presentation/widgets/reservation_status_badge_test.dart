  ...
  group('ReservationStatusBadge', () {
    testWidgets('should display pending label', (tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
            body: ReservationStatusBadge(status: ReservationStatus.pending),
          ),
        ),
      );
    ...
    testWidgets('should display confirmed label', (tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
            body: ReservationStatusBadge(status: ReservationStatus.confirmed),
          ),
        ),
      );
    ...
    testWidgets('should display completed label', (tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
            body: ReservationStatusBadge(status: ReservationStatus.completed),
          ),
        ),
      );
    ...
    testWidgets('should display noShow label', (tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
            body: ReservationStatusBadge(status: ReservationStatus.noShow),
          ),
        ),
      );
    ...
    testWidgets('should display rejected label', (tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
            body: ReservationStatusBadge(status: ReservationStatus.rejected),
          ),
        ),
      );
    ...
    testWidgets('should display cancelled label', (tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
            body: ReservationStatusBadge(status: ReservationStatus.cancelled),
          ),
        ),
      );
